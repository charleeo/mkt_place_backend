                                ...
                                <div class="column" style="text-align: left;color: #787778;font-size: 16px;line-height: 24px;font-family: Ubuntu,sans-serif; padding: 5%;">
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div class="btn btn--flat btn--large actionbtns" style="Margin-bottom: 20px;text-align: justify;">
                                            <p>Dear {{$name}},</p>
                                            @if($status)
                                            <p>Thank you for choosing our platform to expand your influence and create remarkable collaborations. We are delighted to have you on board. On this regard, your account has been verified. </p>
                                            @else()

                                            <p>Thank you for choosing our platform to expand your influence and create remarkable collaborations. However, your account has been suspended. </p>
                                            @endif
                                        </div>
                                    </div>
