...
<body class="main full-padding" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;">
  <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
    <tbody>
      <tr>
        <td>
          <!-- barner -->
          ...
          <div>
            <div class="layout one-col fixed-width stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
              ...
              <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;">
                ...
                <div class="column" style="text-align: left;color: #787778;font-size: 16px;line-height: 24px;font-family: Ubuntu,sans-serif; padding: 5%;">
                  ...
                  <div style="Margin-left: 0px;Margin-right: 0px;">
                    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                      <h5 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 20px;line-height: 38px;text-align: left;">
                        <b>{{ $subject ?? '' }}</b>
                      </h5>
                  ...
                  <div style="Margin-left: 20px;Margin-right: 20px;">
                    <div class="btn btn--flat btn--large actionbtns" style="Margin-bottom: 20px;text-align: justify;">
                      <p>Thank you for choosing our platform to expand your influence and create remarkable collaborations. We are delighted to have you on board. To ensure the security of your account and access to all features, we need to verify your email address.</p>
                      <p>Please click the button below to verify your email address and activate your account. </p>
                      <p> <b>Link expires in {{ $tokenExpires }} hour(s).</b> </p>
                    </div>
                  </div>
                  ...
                  <div style="Margin-left: 20px;Margin-right: 20px;">
                    <div class="btn btn--flat btn--large actionbtns" style="Margin-bottom: 20px;text-align: justify;">
                      <p> By confirming your email, you'll gain full access to your Influenzit account, where you can start connecting with businesses and fellow influencers, manage campaigns, and more.</p>
                      <p>If you didn't create an account with Influenzit, please disregard this email, and no further action will be required.</p>
                      <p>Thank you for your attention to this matter. We look forward to supporting your journey on Influenzit!</p>
                      <p>Best Regards,</p>
          ...
          <div role="contentinfo">
            ...
            <div class="layout email-flexible-footer email-footer" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;" dir="rtl" id="footer-content">
              <div class="layout__inner right-aligned-footer" style="border-collapse: collapse;display: table;width: 100%;">
                ...
                <div class="column" style="text-align: right;font-size: 12px;line-height: 19px;color: #787778;font-family: Ubuntu,sans-serif;" dir="ltr">
                  <div class="footer-logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #7b663d;font-family: Roboto,Tahoma,sans-serif;" align="center">
                    <div style="margin-left: 20px;" emb-flexible-footer-logo align="center"><img style="border: 0;display: block;height: auto; max-width: 80px;" src="https://api.influenzit.com/assets/images/influenzit_logo.png" alt="" height="80" /></div>
                  </div>
                </div>
                <!--[if (mso)|(IE)]></td><![endif]-->
                <!--[if (mso)|(IE)]><td valign="top" class="w60"><![endif]-->
                <div class="column" style="text-align:center; font-size: 12px;line-height: 19px;color: #787778;font-family: Ubuntu,sans-serif;" dir="ltr">
                  <div style="margin-left: 0;margin-right: 0;Margin-top: 10px;Margin-bottom: 10px; display: flex; justify-content: space-around;">
                  </div>
                </div>
                <!--[if (mso)|(IE)]></td><![endif]-->
                <!--[if (mso)|(IE)]><td valign="top" class="w260"><![endif]-->
                <table style="border-collapse: collapse;table-layout: fixed;display: inline-block;width: 156px; display: flex; width: 100%; justify-content: center;" cellpadding="0" cellspacing="0">
                  <tbody>
                    <tr>
                      <td>
                        <div class="column js-footer-additional-info" style="text-align: right;font-size: 12px;line-height: 19px;color: #787778;font-family: Ubuntu,sans-serif;width: 100%;" dir="ltr">
