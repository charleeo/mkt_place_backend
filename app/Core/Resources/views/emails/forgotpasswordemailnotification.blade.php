                ...
                <div class="column" style="text-align: left;color: #787778;font-size: 16px;line-height: 24px;font-family: Ubuntu,sans-serif; padding: 5%;">
                  ...
                  <div style="Margin-left: 20px;Margin-right: 20px;">
                    <div class="btn btn--flat btn--large actionbtns" style="Margin-bottom: 20px;text-align: justify;">
                      <p>We've received a request to reset your Influenzit account password associated with this email address. We understand that it happens to the best of us and we're here to assist you.</p>
                  ...
                  <div style="Margin-left: 20px;Margin-right: 20px;">
                    <div class="btn btn--flat btn--large actionbtns" style="Margin-bottom: 20px;text-align: justify;">
                      This link will expire in {{$tokenExpires}} hours, so be sure to reset your password as soon as possible.
                      <p> If you did not request a password reset, please ignore this email or reach out to our support team if you believe this to be an error. Your account's security is our top priority.</p>
                      <p>Thank you</p>
                      <p>The Market Place (MKT) Team"</p>
                    </div>
                  </div>
