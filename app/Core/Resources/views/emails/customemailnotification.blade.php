                ...
                <div class="column"
                  ...
                  <div style="Margin-left: 0px;Margin-right: 0px;">
                    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                      ...
                      <div style="Margin-top: 20px;Margin-bottom: 20px; background: whitesmoke; padding: 10px 10px 30px 20px; border-radius: 10px;">&nbsp;<br />
                ...
                <div class="column"
                  ...
                  <div class="footer-logo emb-logo-margin-box"
                    ...
                    <div style="margin-left: 20px;" emb-flexible-footer-logo align="center"><img
                        ...
                        src="https://api.influenzit.com/assets/images/influenzit_logo.png" alt="" width="180" /></div>
                  </div>
                  </div>
                  <!--[if (mso)|(IE)]></td><![endif]-->
                    ...
                    <div
                      ...
                      <div class="footer__share-button">
                        ...
                        <div class="flexible-footer__share-button__container"
                          style="Margin-bottom: 6px;mso-line-height-rule: exactly;margin-left: 20px;">
                          <fblike class="icon-white"
                            style="border-radius: 2px;color: white;display: inline-block;font-size: 11px;font-weight: bold;line-height: 19px;text-align: left;text-decoration: none;border-style: solid;border-width: 4px 0 4px 4px;mso-border-width-alt: 4px 8px 8px 8px;background-color: #787878;border-color: #787878;mso-border-color-alt: #787878;width: 81px;box-sizing: content-box;">
